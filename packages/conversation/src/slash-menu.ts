...
export const SLASH_COMMANDS: SlashCommandItem[] = [
  ...
  { cmd: '/diff', desc: 'Inspect the changes a completed run would apply' },
  { cmd: '/pr', desc: 'Create a pull request for a completed run' },
  { cmd: '/discard', desc: 'Discard a completed run without applying it' },
  ...
  { cmd: '/cancel', desc: 'Cancel active plan execution or reassign task' },
